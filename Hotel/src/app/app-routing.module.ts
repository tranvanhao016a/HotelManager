...
{ path: 'edit-staff/:idStaff', loadChildren: () => import('./pages/admin/edit-staff/edit-staff.module').then(m => m.EditStaffModule) },
{ path: 'dashboard', loadChildren: () => import('./pages/admin/dashboard/dashboard.module').then(m => m.DashboardModule) },
  ...
  { path: 'edit-service/:idService', loadChildren: () => import('./pages/admin/edit-service/edit-service.module').then(m => m.EditServiceModule) },
  ...
  { path: 'edit-user/:username', loadChildren: () => import('./pages/admin/edit-user/edit-user.module').then(m => m.EditUserModule) },
  ...
  { path: 'roomvouchers-detail/:idRV', loadChildren: () => import('./pages/admin/roomvouchers-detail/roomvouchers-detail.module').then(m => m.RoomvouchersDetailModule) },
